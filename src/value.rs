...
impl Table {
    ...
    pub fn index_array(&self, i: i64) -> &Value {
        self.array.get(i as usize - 1).unwrap_or_else(|| self.map.get(&Value::Integer(i as i64)).unwrap_or(&Value::Nil))
    }
    ...
    pub fn new_index_array(&mut self, i: i64, value: Value) {
        ...
        if i > 0 && (i < 4 || self.array.capacity() as i64 * 2) {
...
impl From<bool> for Value {
    fn from(v: bool) -> Self { Value::Boolean(b) }
}
